...
class Drivetrain
{
  ...
  public:
	...
	//FRONT
	const double CROSSHAIR_TY_ANGLE_LOW_HIGH_HATCH_FRONT = -13.69; // 10.9;
	...
	//BACK
	const double CROSSHAIR_TY_ANGLE_LOW_HIGH_HATCH_BACK = -5.29;
	...
	//FRONT
	const double SLOPE_LOW_HIGH_HATCH_FRONT = 0.8097;//0.6786874594; //0.790512334;
	...
	//BACK
	const double SLOPE_LOW_HIGH_HATCH_BACK = -0.59824;
	const double INTERCEPT_LOW_HIGH_HATCH_BACK = 0.0;
	...
	//Distances
	//Front
	const double HATCH_LOW_HIGH_FRONT_DESIRED_INCHES = 22.5; //19 HIGH
	const double HATCH_MID_FRONT_DESIRED_INCHES = 39.5;
	const double CARGO_SHIP_FRONT_DESIRED_INCHES = 41.5;
	const double FRONT_INIT_PIPELINE_DESIRED_INCHES = 20;

	//Back
	const double HATCH_LOW_HIGH_BACK_DESIRED_INCHES = 18; //17 HIGH
	const double HATCH_MID_BACK_DESIRED_INCHES = 28.8;
	const double CARGO_SHIP_BACK_DESIRED_INCHES = 28.7;
