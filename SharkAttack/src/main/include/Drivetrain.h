...
class Drivetrain
{
  ...
  public:
	...
	//Distances
	//Front
	const double HATCH_LOW_HIGH_FRONT_DESIRED_INCHES = 23.6; //18.25 HIGH
	...
	//Back
	const double HATCH_LOW_HIGH_BACK_DESIRED_INCHES = 27.4; //27.6 HIGH
	const double HATCH_MID_BACK_DESIRED_INCHES = 51.4;
