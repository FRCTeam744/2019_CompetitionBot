...
class Drivetrain
{
  ...
  public:
	...
	//BACK
	const double CROSSHAIR_TY_ANGLE_LOW_HIGH_HATCH_BACK = -9.31;
	...
	//BACK
	const double SLOPE_LOW_HIGH_HATCH_BACK = -0.576;
	...
	//Back
	const double HATCH_LOW_HIGH_BACK_DESIRED_INCHES = 18.5;
