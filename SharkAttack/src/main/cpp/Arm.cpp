...
//finish setup of file, this is trying to set up some periodic stuff that can't be put in an init method
//based off of Drivetrain's periodic of the NavX variables
=======
/*----------------------------------------------------------------------------------*/
